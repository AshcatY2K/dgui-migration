export default class Dialog {
  ...
  init() {
    ...
    <form method="dialog" data-ref="form" tabindex="0">
      <fieldset data-ref="fieldset" role="document">
        <p data-ref="message" id="${(Math.round(Date.now())).toString(36)}"></p>
        <div data-ref="template"></div>
      </fieldset>
      <menu class="d-flex justify-content-between">
        <button${this.dialogSupported ? '' : ` type="button"`} 
          class="btn btn-warning" data-ref="cancel" value="cancel"></button>
        <button${this.dialogSupported ? '' : ` type="button"`} 
          class="btn btn-primary" data-ref="accept" value="default"></button>
      </menu>
