...
import * as mdbModal from '../mdb/pro/modal';
...
class TableEditor {
  ...
  _createModal() {
    ...
    this._modalInstance = new mdbModal(this._modal, { backdrop: 'static', keyboard: false });
  ...
  _setInputs() {
    ...
    SelectorEngine.find(SELECTOR_INPUT_SELECT, this._element).forEach((element) => {
      new Select(element); // eslint-disable-line
    });
