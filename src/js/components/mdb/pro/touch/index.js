...
class Touch {
  ...
  init() {
    ...
    EventHandler.on(this._element, 'touchstart', this._touchStartHandler, {passive: true});

    // istanbul ignore next
    EventHandler.on(this._element, 'touchmove', this._touchMoveHandler, {passive: true});

    // istanbul ignore next
    EventHandler.on(this._element, 'touchend', this._touchEndHandler, {passive: true});
  }
